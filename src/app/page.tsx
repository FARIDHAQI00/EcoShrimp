  ...
  return (
    <>
      ...
      <section className="section">
        <div className="container">
          <Reveal>
            <div className="card-feature glass-strong hover-lift" style={{ overflow: "hidden", position: "relative" }}>
              {/* Decorative animated elements */}
              <div style={{ position: "absolute", top: -50, right: -50, width: 200, height: 200, background: "var(--color-primary)", opacity: 0.1, borderRadius: "50%", filter: "blur(40px)" }} />
              <div style={{ position: "absolute", bottom: -50, left: -50, width: 200, height: 200, background: "var(--color-accent)", opacity: 0.1, borderRadius: "50%", filter: "blur(40px)" }} />

              <div className="consult-grid" style={{ position: "relative", zIndex: 1 }}>
                <div>
                  <span className="tag" style={{ background: "rgba(244,135,74,.16)", color: "var(--color-accent)", border: "1px solid rgba(244,135,74,0.3)" }}>
                    <Sparkles size={13} /> Asisten Ahli EcoShrimp
                  </span>
                  <h2 className="section-title" style={{ color: "#fff", marginTop: 14 }}>
                    Panduan teknis tambak & kebun.
                  </h2>
                  <p style={{ color: "#C49484", marginTop: 10, fontSize: "1.1rem", lineHeight: 1.6 }}>
                    Dapatkan pendampingan teknis gratis seputar olah limbah, dosis pupuk, hingga manajemen pakan langsung dari asisten ahli kami.
                  </p>
                  <div className="consult-q">
                    <AskChip question="Bagaimana cara membuat pakan udang dari cangkang udang?" />
                    <AskChip question="Berapa dosis Chito Grow untuk tanaman cabai?" />
                    <AskChip question="Jadwal penjemputan limbah minggu ini?" />
                  </div>
                  <div className="mt-6">
                    <AskChip variant="cta" label="Mulai Tanya Ahli" />
                  </div>
                </div>
