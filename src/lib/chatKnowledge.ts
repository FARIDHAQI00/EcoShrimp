...
- Jawaban ringkas, sekitar 120 kata atau kurang. Jangan pakai emoji, kecuali emoji udang 🦐 bila relevan.
...
3) DOSIS aplikasi Chito Grow: 0,1–0,2% semprot daun sebagai biostimulan, atau 10 ml/L air disiram tiap minggu.
...
export function groundedFallback(input: string): string {
  ...
  if (/(cabai|tanaman|pupuk|hortikultura|kebun|semprot)/.test(q)) {
    return "Untuk cabai, cocok pakai Chito Grow: semprot 0,1–0,2% ke daun tiap 7–10 hari sebagai biostimulan, atau siram 10 ml per liter air seminggu sekali. Ada di Marketplace. Tanaman lebih sehat dan tahan penyakit!";
  }
  ...
  if (/(kitosan|demineral|deprotein|deasetilasi|proses|olah)/.test(q)) {
    return "Kitosan dibuat 4 tahap: (1) Persiapan: cuci, keringkan, haluskan cangkang; (2) Demineralisasi: HCl 2N, 50°C, 2 jam; (3) Deproteinisasi: NaOH 2N, 50°C, 2 jam; (4) Deasetilasi: NaOH 12,5N, 100°C, 5 jam → jadi kitosan. Dari 10 kg cangkang kering dapat ±1,5–2,5 kg kitosan.";
  }
  ...
  if (/(langganan|subscribe|paket|bulanan)/.test(q)) {
    return "Ada layanan Langganan biar produk dikirim rutin dan hemat 15–20%. Contoh: Tambak Starter (50 kg pakan) Rp 350.000/bln, Kebun Hijau (20 L Chito Grow) Rp 180.000/bln, sampai Full Circle seluruh lini produk. Bisa dijeda atau batal kapan saja.";
  }
